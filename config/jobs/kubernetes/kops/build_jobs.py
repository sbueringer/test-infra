...
def generate_presubmits_e2e():
    jobs = [
        ...
        presubmit_test(
            name="pull-kops-aws-upgrade-k133-ko133-to-kstable-kolatest-many-addons",
            optional=True,
            distro='u2204',
            networking='cilium',
            k8s_version='stable',
        ...
        presubmit_test(
            name="pull-kops-aws-upgrade-k134-ko134-to-kstable-kolatest-many-addons",
            optional=True,
            distro='u2404',
            networking='cilium',
            k8s_version='stable',
        ...
        presubmit_test(
            name="pull-kops-aws-upgrade-k135-ko135-to-kstable-kolatest-many-addons",
            optional=True,
            distro='u2404',
            networking='cilium',
            k8s_version='stable',
