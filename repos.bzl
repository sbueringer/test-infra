...
def go_repositories():
    ...
    go_repository(
        ...
        sum = "h1:6zwCJ9X8NMizf4wMEGQjqTUV+otsB+NwyJftt2Ua9Oo=",
        version = "v1.23.22",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:S+ef0492XaIknb8LMjcwgW2i3cNTzDYMmDrOThOJNWc=",
        version = "v1.9.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:jWEF93SRnvpihdWupwLxMpcyzhD7ogiZAE9GSK1tFno=",
        version = "v0.8.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:41hwlulw1prEMBxLQSlMSux1zxJf07B3WPsdjJlKZxE=",
        version = "v0.0.0-20190912141932-bc967efca4b8",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:xID9Mrq7YTmZejkQpdtjPTL5rN56sSZcoU6l5AUD4Mk=",
    ...
    go_repository(
        ...
        sum = "h1:w+AcPuGp389HAI5FDW9L0j7MQbxnU1RtZfLP7BMgNDI=",
        version = "v0.0.0-20191101194912-56c2594e4f11",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Eu2hrW4LGI09yM1l5I1PPXnFVzfDw8TMG+VTh/PKSK0=",
        version = "v0.0.0-20190605020000-c4ba1fdf4d36",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:HX6uFZYZs9tUP87jzoWgB8dl4ihsRpiAsBDKTthiApY=",
        version = "v0.18.0",
    )
    go_repository(
